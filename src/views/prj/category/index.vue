<template>
    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['prj:category:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['prj:category:export']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['prj:category:delete']"
        >
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-table-column label="项目类别名称" align="center" prop="categoryName" />
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['prj:category:update']"
          >
            编辑
          </el-button>
          <el-button
