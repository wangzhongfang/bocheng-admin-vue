<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="预算等级" prop="budgetLevel">
        <el-input
          v-model="queryParams.budgetLevel"
          placeholder="请输入预算等级"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['prj:budget-type:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['prj:budget-type:export']"
        >
        ...
        <el-button
            ...
            v-hasPermi="['prj:budget-type:delete']"
        >
  ...
  <ContentWrap>
    ...
    <el-table-column type="selection" width="55" />
      ...
      <el-table-column label="预算等级" align="center" prop="budgetLevel" />
      <el-table-column label="预算编码" align="center" prop="budgetCode" />
      <el-table-column label="状态 0.已封存 1.未封存" align="center" prop="status" />
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['prj:budget-type:update']"
          >
            编辑
          </el-button>
          <el-button
...
const handleExport = async () => {
  try {
    ...
    const data = await BudgetTypeApi.exportBudgetType(queryParams)
    download.excel(data, '项目-预算类型.xls')
  } catch {
  } finally {
